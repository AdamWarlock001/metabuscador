    ...
    */
    function configureWSDL($serviceName,$namespace = false,$endpoint = false,$style='rpc', $transport = 'http://schemas.xmlsoap.org/soap/http', $schemaTargetNamespace = false)
    {
        ...
        if(false == $endpoint) {
			...
			$SCRIPT_NAME = str_replace('index.php', 'webservice_soap/server.php', $SCRIPT_NAME);
...
class nusoap_client extends nusoap_base  {
	...
	*/
	...
	function loadWSDL() {
		...
		$this->wsdl -> wsdl('',$this->proxyhost,$this->proxyport,$this->proxyusername,$this->proxypassword,$this->timeout,$this->response_timeout,$this->curl_options,$this->use_curl);
